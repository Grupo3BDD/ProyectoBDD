# Generated by Django 4.2 on 2023-05-05 00:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinador_acad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.coordinadoracademico')),
                ('encargado_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.encargadoarea')),
            ],
        ),
        migrations.CreateModel(
            name='Ciclo',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipociclo', models.CharField(max_length=70)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pensum.curso')),
            ],
        ),
        migrations.CreateModel(
            name='DetalleCarrera',
