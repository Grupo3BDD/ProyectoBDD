    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escala', models.SlugField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noPersonal', models.SlugField(unique=True)),
                ...
                ('pais_origen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.paisorigen')),
